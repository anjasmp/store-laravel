...
<div class="page-content page-home">
        ...
        <section>
            <div class="search d-none d-md-flex d-sm-flex">
                <div class="container search">
                    <div class="row">
                        <div class="col justify-content-center" data-aos="zoom-in">
                            <div id="cover">
                                <form method="get" action="/dashboard.html">
                                    <div class="tb">
                                    <div class="td"><input autofocus type="text" placeholder="Search" required></div>
                                    <div class="td" id="s-cover">
                                        <button type="submit" style="outline-style: none;">
                                        <div id="s-circle"></div>
                                        </button>
                                    </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="categories-image">
                                <img
                                src="/images/category-gadgets.svg"
                                alt=""
                                class="w-100"
                                />
                            </div>
                        ...
                        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="100">
                            <a href="#" class="component-categories d-block">
                                <div class="categories-image">
                                    <img src="/images/category-furniture.svg" alt="" class="w-100" />
                                </div>
                        ...
                        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="200">
                            <a href="#" class="component-categories d-block">
                                <div class="categories-image">
                                    <img src="/images/category-makeup.svg" alt="" class="w-100" />
                                </div>
                        ...
                        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="300">
                            <a href="#" class="component-categories d-block">
                                <div class="categories-image">
                                    <img src="/images/category-sneaker.svg" alt="" class="w-100" />
                                </div>
                        ...
                        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="400">
                            <a href="#" class="component-categories d-block">
                                <div class="categories-image">
                                    <img src="/images/category-tools.svg" alt="" class="w-100" />
                                </div>
                        ...
                        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="500">
                            <a href="#" class="component-categories d-block">
                                <div class="categories-image">
                                    <img src="/images/category-baby.svg" alt="" class="w-100" />
                                </div>
